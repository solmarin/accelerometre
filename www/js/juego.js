var app={
  ...
  iniciaJuego: function(){
    ...
    function create() {
      ...
      timeText = fame.add.text(40,16, "Time:"+time, {fontSize: '12px', fill: '#757676' });
    ...
    function update(){
      ...
      if(colorPared){
        game.stage.setBackgroundColor('#FF2D00');
        music.play();
      }else {
        game.stage.setBackgroundColor('#f27d0c');
        music.stop();
      }
...
//Funcion para controlar el tiempo
  updateClock: function() {
      if(time==0){
          objetivo.kill();
          bola.kill();
          gameOver = fame.add.text(16,100, "GAME OVER", {fontSize: '100px', fill: '#757676' });
          game.stage.setBackgroundColor('#00F0F5');
      }else{
          time-=1;
          timeText.text = time;
      }
